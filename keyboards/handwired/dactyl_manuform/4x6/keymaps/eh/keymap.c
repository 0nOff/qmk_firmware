...
[_BASE] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,  KC_X,   KC_C,   KC_V,   KC_B,           KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_BSLASH, \
                    KC_GRV, KC_TILD,                                        KC_LBRC, KC_RBRC,                    \
...
[_LOWER] = LAYOUT(
    ...
    KC_TAB,  _______, _______, _______, _______, _______,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_MINS, KC_EQL,  \
    KC_LSFT, _______, _______, _______, _______, _______,   _______, _______, _______, _______,  KC_UNDS, KC_PLUS, \
